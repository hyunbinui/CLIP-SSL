...
#SBATCH --mem=50000MB                   # Using 50GB CPU Memory (MIN_MEMORY)
#SBATCH --job-name=inter_n1_g4_b4
...
srun --cpu-bind=v --accel-bind=gn python -m training.main --use-inter-loss --save-most-recent --delete-previous-checkpoint  \
...
--name cl_inter_coco_6_test1_eva_vitb16_12layers_$current_time --downsample-factor 16 --det-image-size 1024 \
--alpha 0.7
