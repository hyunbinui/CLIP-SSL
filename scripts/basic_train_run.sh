...
#SBATCH --job-name=basic_n1_g2_b2
...
srun --cpu-bind=v --accel-bind=gn python -m training.main --save-most-recent --delete-previous-checkpoint --resume logs/clipself_coco_6_test1_eva_vitb16_12layers_2024.01.03-17.09.38/checkpoints/epoch_latest.pt  \
--batch-size=2 --lr=1e-5 --wd=0.1 --epochs=6 --workers=4 \
...
--name basic_coco_6_test1_eva_vitb16_12layers_$current_time --downsample-factor 16 --det-image-size 1024 \
--alpha 0.7
